...
```
You'd need to call 500x.  The formula is totalFriendships = averageFriendships * numUsers // 2.
Plug 100 users and 10 friends each into the equation and you get 500 -->  10 * 100 // 2 = 500
```
2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?
```
There's a 99.5% to be in another user's extended social netowkr. The avg degree of separation between a user and those in extended network will be 5.5 after 20+ runs
```
